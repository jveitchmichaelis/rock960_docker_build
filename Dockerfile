...
RUN wget https://raw.githubusercontent.com/rockchip-linux/kernel/stable-4.4-rk3399-linux/arch/arm64/configs/rockchip_linux_defconfig -P rock960dev/kernel/arch/arm64/configs/
...
RUN echo "CONFIG_OVERLAY_FS=y" >> rock960dev/kernel/arch/arm64/configs/rockchip_linux_defconfig \
    && echo  "CONFIG_NF_NAT=y" >> rock960dev/kernel/arch/arm64/configs/rockchip_linux_defconfig \
...
RUN sed -i "s/UBOOT_DEFCONFIG=rock960-ab-rk3399_defconfig/UBOOT_DEFCONFIG=rk3399_defconfig/g" rock960dev/build/board_configs.sh
